...
// ShareHandler file share HTTP handler
type ShareHandler struct {
	shareSvc *service.ShareService
	fileSvc  *service.FileService
}

// NewShareHandler create the share handler
...
// CreateShareHandler create a share
// POST /file/share: filehash, days (1-30, default 7), password (optional)
...
// ShareListHandler list my shares
// GET /file/share/list
...
// RevokeShareHandler revoke a share
...
// ShareDownloadHandler share download without login (public route, supports Range)
// GET /share/:token?pwd=access code (optional)
...
// streamSharedFile stream share file content (supports Range 206)
